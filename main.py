...
question_btn_rect.center = (WIDTH // 3.3, HEIGHT // 6)
...
class Draw:
    ...
    def draw_charact_menu(self):
        ...
        # Ресурсы игрока
        get_text(25, "Пшено", 3, 4, (0, 0, 0), millet)
        get_text(25, "Сено", 3, 3.4, (0, 0, 0), hay)
        get_text(25, "Комки активации", 3, 3, (0, 0, 0), main_res)
        get_text(25, "Древесина", 2, 4, (0, 0, 0), tree_res)
        get_text(25, "Камень", 2, 3.4, (0, 0, 0), hay_res)
        ...
        get_text(25, "Скорость +", 2.8, 1.8, (0, 0, 0))
        get_text(25, "Атака +", 2.08, 1.8, (0, 0, 0))
        get_text(25, "Сила +", 1.63, 1.8, (0, 0, 0))
